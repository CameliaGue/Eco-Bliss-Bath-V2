describe('Panier', () => {
    ...
    // Test 1 : Un produit disponible doit pouvoir être ajouté au panier,
    ...
    // Test 2 : Le stock du produit est relevé avant et après l'ajout au panier,
    ...
    // Test 3 : Une quantité largement supérieure au stock disponible est ajoutée volontairement,
    ...
    // Test 4 : Une quantité négative doit être bloquée directement au niveau de l'interface,
    ...
    // Test 5 : Une quantité de 0 n'a pas de sens métier et ne devrait pas créer de ligne de panier
    ...
    // Test 6 : Une quantité supérieure à la limite métier de 20 ne devrait pas être acceptée
    ...
    // Test 7 : Le champ indiquant la disponibilité du produit doit être visible sur la page
